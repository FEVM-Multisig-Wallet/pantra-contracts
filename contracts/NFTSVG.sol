...
library NFTSVG {
    ...
    function generateSVGCardMantle(
        ...
        svg = string(
            abi.encodePacked(
                ...
                'Pantra'
                '</text><text y="90px" x="32px" fill="white" font-family="\'Courier New\', monospace" font-weight="50" font-size="9px">',
                'Powered by Lightlink',
                '</text></g>',
                '</text><text y="150px" x="32px" fill="white" font-family="\'Courier New\', monospace" font-weight="200" font-size="36px">',
                walletBalance,
                ' ETH',
                '</text></g>',
    ...
    // function tickToString(uint24 tick) private pure returns (string memory) {
    //     string memory sign = '';
    //     // if (tick < 0) {
    //     //     tick = tick * -1;
    //     //     sign = '-';
    ...
    // function rangeLocation(uint24 tickLower, uint24 tickUpper) internal pure returns (string memory, string memory) {
    //     uint24 midPoint = (tickLower + tickUpper) / 2;
    //     if (midPoint < -125_000) {
    //         return ('8', '7');
